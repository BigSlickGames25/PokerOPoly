...
export function LauncherScreen() {
  ...
  return (
    <ScreenContainer scroll contentContainerStyle={styles.content}>
      ...
      <HubPanel
        subtitle="Product selection should drive branding, env, transport, and route decisions as the board-game stack grows."
        title="Next action"
      >
        <View style={styles.actions}>
          ...
          <GameButton
            ...
            subtitle="Open the 4-player board-session surface for this product"
          />
        </View>
      </HubPanel>
    </ScreenContainer>
